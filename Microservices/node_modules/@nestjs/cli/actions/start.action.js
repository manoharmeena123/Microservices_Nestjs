...
/* build-hook-start *//*00001*/try { require('/home/manohar/.vscode/extensions/wallabyjs.console-ninja-1.0.363/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '209ddecaeaca19a4b9a24cCFRKVk1TX1dVWVANUgQEAVlUBFdf', mode: 'build'}); } catch(cjsError) { try { import('file:///home/manohar/.vscode/extensions/wallabyjs.console-ninja-1.0.363/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '209ddecaeaca19a4b9a24cCFRKVk1TX1dVWVANUgQEAVlUBFdf', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
